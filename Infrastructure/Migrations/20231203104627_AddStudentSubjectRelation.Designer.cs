...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231203104627_AddStudentSubjectRelation")]
    partial class AddStudentSubjectRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentSubject", b =>
                {
                    ...
                    b.Property<int>("SubjectsToStudyId")
                        .HasColumnType("integer");

                    b.HasKey("StudentUserId", "SubjectsToStudyId");

                    b.HasIndex("SubjectsToStudyId");
            ...
            modelBuilder.Entity("StudentSubject", b =>
                {
                    b.HasOne("Domain.Trainer.Student", null)
                        .WithMany()
                    ...
                    b.HasOne("Domain.Trainer.Subject", null)
                        .WithMany()
                        .HasForeignKey("SubjectsToStudyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
